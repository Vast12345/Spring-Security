package com.securityspring.app_security.infrastructure.utils.exceptions;
...
import com.securityspring.app_security.domain.dtos.ApiError;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handlerMethodArgumentNotValidException(MethodArgumentNotValidException exception, HttpServletRequest request) {
        ...
        error.setMessage("Error: la peticion enviada posee un formato incorrecto");
        error.setBackedMessage(exception.getLocalizedMessage());
        error.setTime(LocalDateTime.now());
